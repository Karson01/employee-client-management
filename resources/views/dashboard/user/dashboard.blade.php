                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu d-flex">
                     ...
                     <li class="active">
                        ...
                        <ul id="menu-design" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                           <li class="active"><a href="{{url('user/employee')}}"><i class="ri-git-commit-line"></i>Add</a></li>
                                       ...
                                       <div class="row">
                                          <div class="col-md-6 col-lg-3">
                                             <div class="d-flex align-items-center mb-3 mb-lg-0">
                                                <div class="rounded-circle iq-card-icon iq-bg-primary dark-icon-light mr-3"> <i class="ri-mail-open-line"></i></div>
                                                <div class="text-left">
                                                   <h4>425</h4>
