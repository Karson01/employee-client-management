                  ...
                  <div class="iq-card">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title">Employee Work</h4>
                        </div>                        
                     ...
                     <div class="iq-card-body">
                        <div class="table-responsive">
                           <div class="row justify-content-between">
                              <div class="col-sm-12 col-md-6">
                                 <div id="user_list_datatable_info" class="dataTables_filter">
                                    <h6 class="card-title">Employee time clock</h6>
                                    <h4 class="card-title">Mario rossi - codiceFiscale</h4>
                                 </div>
                              </div>
                              <!--div class="col-sm-12 col-md-6">
                           ...
                           <table class="table table-bordered table-responsive-md table-striped text-center">
                             ...
                             <tbody>
                               <tr>
                                 <td contenteditable="true">Mon 1 July</td>
                               ...
                               <tr>
                                 <td contenteditable="true">Mon 2 July</td>
                                 <td contenteditable="true">7.00</td>
                                 <td contenteditable="true">13.00</td>
                                 <td contenteditable="true">14.00</td>
                                 <td contenteditable="true">17.00</td>
                               ...
                               <tr>
                                 <td contenteditable="true">Mon 3 July</td>
                                 <td contenteditable="true">7.00</td>
                                 <td contenteditable="true">13.00</td>
                                 <td contenteditable="true">14.00</td>
                                 <td contenteditable="true">17.00</td>
                               ...
                               <tr>
                                 <td contenteditable="true">Mon 4 July</td>
                                 <td contenteditable="true">7.00</td>
                                 <td contenteditable="true">13.00</td>
                                 <td contenteditable="true">14.00</td>
                                 <td contenteditable="true">17.00</td>
